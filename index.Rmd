---
title: <center> Welcome to the Home of the WCM Biostatistics Computing and Data Science Clubs! </center>
output: html_document
---

<br>

<center><img src="file_resources/WCM_PopulationHealthSciences_LOGO_HZSS1L_CLR_RGB.png" alt="hi" width="483" height="70"><img src="file_resources/WCM_CTSC-Long_LOGO_HZSS1L_CLR_RGB.png" alt="hi" style="text-align:center;" width="380" height="100"></center>

<br>

## {.tabset .tabset-fade .tabset-pills}

### WCM Biostatistics Computing Club (WCM-BCC)
...
The club was founded in 2018 by [Jihui Lee](https://jihuilee.com) and [Elizabeth Mauer](https://phs.weill.cornell.edu/directory/profiles/mauer-elizabeth). Jihui enjoyed [Columbia Biostatistics Computing Club](https://columbia-computing-club.github.io) as a graduate student and was inspired to create a club for staff and faculty in the Department of Population Health Sciences at Weill Cornell Medicine. In 2021, [Katherine Hoffman](https://www.khstats.com) joined to plan and organize computing club sessions. The club is hosted by the [Division of Biostatistics](http://hpr.weill.cornell.edu/divisions/biostatistics/), [Department of Population Health Sciences](https://phs.weill.cornell.edu) along with the [Biostatistics, Epidemiology and Research Design (BERD) Core](https://ctscweb.weill.cornell.edu/about-us/ctsc-programs/biostatistics-epidemiology-and-research-design), [Clinical and Translational Science Center](https://ctscweb.weill.cornell.edu/).
